...
설문 기반 건강 데이터를 활용하여 통계적으로 요인을 분석하고 심장질환 위험을 예측하며, 확률 보정과 해석 가능성을 함께 고려한  
...
본 프로젝트는 BMI, 생활습관, 기저질환, 주관적 건강 상태 등의 정보를 기반으로  
심장질환 위험도를 예측하고, 이를 서비스 형태로 제공합니다.
